# Life cycle variation and resource dynamics ABM: Scenario 3 - Code ----

#Here is the code to set up the simulation of Scenario 3, which aims to understand the influence of resource transfers on the variability of life cycles.
...
output_dir <- "SCenario_3/fst_results"
