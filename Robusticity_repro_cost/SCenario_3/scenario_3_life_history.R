...
for (m in 1:19) {
  for (r in 1:10) {
    ...
    file_path <- sprintf("./Robusticity_repro_cost/SCenario_3/fst_results/results_m%d_r%d.fst", m, r)
    ...
    if (file.exists(file_path)) {
      ...
      if (!dir.exists("./Robusticity_repro_cost/SCenario_3/samples/")) {
        dir.create("./Robusticity_repro_cost/SCenario_3/samples/", recursive = TRUE)
      }
      
      # Save each filtered sample as an .fst file
      output_file <- sprintf("./Robusticity_repro_cost/SCenario_3/samples/raw_sample_m%d_r%d.fst", m, r)
...
input_dir <- "./Robusticity_repro_cost/SCenario_3/samples/"  # Directory containing raw_sample .fst files
output_dir <- "./Robusticity_repro_cost/SCenario_3/lht_lists/"  # Directory for lht_list .fst files
