...
# Loop over the values of d and r
  for (r in 1:10) {
    ...
    file_path <- sprintf("./Robusticity_surv_cost/Scenario_2/fst_results/results_r%d.fst", r)
    ...
    if (file.exists(file_path)) {
      ...
      if (!dir.exists("./Robusticity_surv_cost/Scenario_2/samples/")) {
        dir.create("./Robusticity_surv_cost/Scenario_2/samples/", recursive = TRUE)
      }
      
      # Save each filtered sample as an .fst file
      output_file <- sprintf("./Robusticity_surv_cost/Scenario_2/samples/raw_sample_r%d.fst", r)
...
input_dir <- "./Robusticity_surv_cost/Scenario_2/samples/"  # Directory containing raw_sample .fst files
output_dir <- "./Robusticity_surv_cost/Scenario_2/lht_lists/"  # Directory for lht_list .fst files
