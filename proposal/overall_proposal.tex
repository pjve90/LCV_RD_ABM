...
\node[state]        (H) [below of=G,node distance=1.5cm] {A};
\node[state]		(I) [right of=A, node distance=5cm]             {2};
...
\node[state]		(O) [below of=N,node distance=1.5cm] {A};
\node[state]        (P) [below of=O,node distance=1.5cm] {G};
\node[state]		(Q) [right of=I, node distance=5cm]             {3};
...
\node[state]		(W) [below of=V,node distance=1.5cm] {A};
\node[state]        (X) [below of=W,node distance=1.5cm] {G};
\node[state]		(Y) [right of=Q, node distance=5cm]             {4};
...
\node[state]		(EE) [below of=DD,node distance=1.5cm] {A};
\node[state]        (FF) [below of=EE,node distance=1.5cm] {G};
\node[state]		(GG) [right of=Y, node distance=5cm]             {5};
...
\node[state]		(MM) [below of=LL,node distance=1.5cm] {A};
...
\node[state]		(TT) [above of=SS,node distance=1.5cm] {A};
...
\node[state]		(AAA) [above of=ZZ,node distance=1.5cm] {A};
