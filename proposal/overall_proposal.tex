...
\node[state]		(A)              {1};
\node[state]        (B) [above left of=A,node distance=1.5cm] {P};
\node[state]        (C) [above right of=A,node distance=1.5cm] {C};
\node[state]        (D) [below left of=A,node distance=1.5cm] {R};
\node[state]        (E) [below right of=A,node distance=1.5cm] {G};
\node[state]		(F) [right of=A, node distance=3.5cm]             {2};
\node[state]        (G) [above left of=F,node distance=1.5cm] {P};
\node[state]        (H) [above right of=F,node distance=1.5cm] {C};
\node[state]        (I) [below left of=F,node distance=1.5cm] {R};
\node[state]        (J) [below right of=F,node distance=1.5cm] {G};
\node[state]		(K) [right of=F, node distance=3.5cm]             {3};
\node[state]        (L) [above left of=K,node distance=1.5cm] {P};
\node[state]        (M) [above right of=K,node distance=1.5cm] {C};
\node[state]        (N) [below left of=K,node distance=1.5cm] {R};
\node[state]        (O) [below right of=K,node distance=1.5cm] {G};
\node[state]		(P) [right of=K, node distance=3.5cm]             {4};
\node[state]        (Q) [above left of=P,node distance=1.5cm] {P};
\node[state]        (R) [above right of=P,node distance=1.5cm] {C};
\node[state]        (S) [below left of=P,node distance=1.5cm] {R};
\node[state]        (T) [below right of=P,node distance=1.5cm] {G};
\node[state]		(U) [right of=P, node distance=3.5cm]             {5};
\node[state]        (V) [above left of=U,node distance=1.5cm] {P};
\node[state]        (W) [above right of=U,node distance=1.5cm] {C};
\node[state]        (X) [below left of=U,node distance=1.5cm] {R};
\node[state]        (Y) [below right of=U,node distance=1.5cm] {G};
\node[state]        (Z) [above of=F,node distance=2.2cm,draw=none,fill=none] {};
\node[state]        (AA) [above of=Z,node distance=2cm] {A};
\node[state]        (BB) [left of=AA,node distance=1cm] {C};
\node[state]        (CC) [left of=BB,node distance=1cm] {P};
\node[state]        (DD) [right of=AA,node distance=1cm] {R};
\node[state]        (EE) [right of=DD,node distance=1cm] {G};
\node[state]        (FF) [above of=O,node distance=3.8cm,draw=none,fill=none] {};
\node[state]        (GG) [above of=FF,node distance=2.3cm] {A};
\node[state]        (HH) [left of=GG,node distance=1cm] {C};
\node[state]        (II) [left of=HH,node distance=1cm] {P};
\node[state]        (JJ) [right of=GG,node distance=1cm] {R};
\node[state]        (KK) [right of=JJ,node distance=1cm] {G};
...
(Y) edge (U)
(U) edge[loop below] (U)
(K) edge[dashed,bend left=-100] (A)
(P) edge[dashed,bend left=-110] (A)
(AA) edge (Z)
(BB) edge (Z)
(CC) edge (Z)
(DD) edge (Z)
