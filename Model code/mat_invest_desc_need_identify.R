...
desc_need <- function(it_indpop){
  if(it_indpop$mom_id[i] %in% it_indpop$id & it_indpop$stage[i]==1 & it_indpop$sotre_a[i] < surv_cost){ #if your mother is alive, you are a juvenile, and don't have enough resources to cover the costs of survival
