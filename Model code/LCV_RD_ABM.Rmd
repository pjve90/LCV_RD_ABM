...
for(desc in 1:nrow(it_descpop_momsub)){.   # Loop through all of the mother's descendants, starting with the offspring with the largest need
    if(it_indpop$mom_surplus_a[i] < it_descpop_momsub$desc_need_a[desc]) {break} # If the mother does not have sufficient resources to cover the needs of the current descendant, she does not invest
