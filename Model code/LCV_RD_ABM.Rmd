...
desc_need <- function(it_indpop){
  if(it_indpop$mom_id[i] == it_indpop$id[i] & it_indpop$res_a[i] < surv_effort){
...
it_indpop$desc_need_a[i] <- (it_indpop$res_a[i] - surv_effort)*it_indpop$desc_need[i]

#Order the descendants by need
