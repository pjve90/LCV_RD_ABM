...
#plot it
pairs(~lng+lro+afr+alr+ibi+prod_res+cons_res+res_av,data=final_ind_data,upper.panel=NULL)
```
...
Different summary statistics are used to describe the life cycles in the population. The description inclues the mean, variance, standard deviation, coefficient of variation, skewness, kurtosis, minimum/maximum value, and quartiles.
