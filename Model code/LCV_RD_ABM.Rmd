...
##### The functions below seem to store additional data in this data frame (e.g. res_prod=resources produced and available). Maybe that needs to be set up here too?
