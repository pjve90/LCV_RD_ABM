...
# Dieter: Again, you could set the reproduction probability up similarly to the survival probability, where resources additionally increase the probability that an individual will reproduce.
