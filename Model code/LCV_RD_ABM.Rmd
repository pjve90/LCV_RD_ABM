...
for(desc in 1:nrow(it_descpop_momsub)){
    if(it_indpop$mom_surplus_a[i] < it_descpop_momsub$desc_need_a[desc]) {break}
    ...
    it_indpop$res_a[it_indpop$id == it_descpop_momsub$id[desc]] <- it_descpop_momsub$res_a[1] #update the resources available of the descendant in the original database
					}
  }
}
