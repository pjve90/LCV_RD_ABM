...
#import raw results_s4 from the simulation
results_s4 <- readRDS("./Scenario_4/lht_list_s4.RData")
...
summary_stats_s4 <- lapply(1:length(results_s4),function(x)list())
#match the original names with the sample
names(summary_stats_s4) <- names(results_s4)
names(summary_stats_s4)

#gather summary statistics of each result
for (i in 1:length(results_s4)){
  if(nrow(results_s4[[i]]) == 0){
    summary_stats_s4[[i]] <- summary_stats_s4[[i]]
  } else{
    summary_stats_s4[[i]]$summary <- summary(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")])
    summary_stats_s4[[i]]$sd <- as.data.frame(lapply(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")],sd,na.rm=T))
    summary_stats_s4[[i]]$mean <- as.data.frame(lapply(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")],mean,na.rm=T))
    summary_stats_s4[[i]]$cv <- summary_stats_s4[[i]]$sd / summary_stats_s4[[i]]$mean
    summary_stats_s4[[i]]$min <- as.data.frame(lapply(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")],min,na.rm=T))
    summary_stats_s4[[i]]$max <- as.data.frame(lapply(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")],max,na.rm=T))
    if(nrow(results_s4[[i]]) == 1 | summary_stats_s4[[i]]$sd$lng == 0 & summary_stats_s4[[i]]$sd$lro == 0){
      summary_stats_s4[[i]]$summary <- summary(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")])
      summary_stats_s4[[i]]$sd <- as.data.frame(lapply(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")],sd,na.rm=T))
      summary_stats_s4[[i]]$sd[,c("lng","lro")][which(is.na(summary_stats_s4[[i]]$sd[,c("lng","lro")]))] <- 0
      summary_stats_s4[[i]]$mean <- as.data.frame(lapply(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")],mean,na.rm=T))
      summary_stats_s4[[i]]$cv[,c("lng","lro")] <- 0  
      summary_stats_s4[[i]]$min <- as.data.frame(lapply(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")],min,na.rm=T))
      summary_stats_s4[[i]]$max <- as.data.frame(lapply(results_s4[[i]][,c("lng","lro","asm","afr","alr","meno")],max,na.rm=T))
    } 
  }
...
#lng
#create data frame to gather means of lng
lng_mean_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lng_mean_s4) <- c("p",1:10)
lng_mean_s4$p <- prod_prob[2,]
#check it
lng_mean_s4
#extract the mean of lng across the parameter space
for(d in 1:nrow(lng_mean_s4)){
  for(r in 2:ncol(lng_mean_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$lng) == T){
      lng_mean_s4[d,r] <- NA
    }else{
      lng_mean_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$lng
    }
  }
}
#check it
...
#lro
#create data frame to gather means of lro
lro_mean_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lro_mean_s4) <- c("p",1:10)
lro_mean_s4$p <- prod_prob[2,]
#check it
lro_mean_s4
#extract the mean of lro across the parameter space
for(d in 1:nrow(lro_mean_s4)){
  for(r in 2:ncol(lro_mean_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$lro) == T){
      lro_mean_s4[d,r] <- NA
    }else{
      lro_mean_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$lro
    }
  }
}
#check it
...
#asm
#create data frame to gather means of asm
asm_mean_s4 <- as.data.frame(matrix(NA,17,11))
colnames(asm_mean_s4) <- c("p",1:10)
asm_mean_s4$p <- prod_prob[2,]
#check it
asm_mean_s4
#extract the mean of asm across the parameter space
for(d in 1:nrow(asm_mean_s4)){
  for(r in 2:ncol(asm_mean_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$asm) == T){
      asm_mean_s4[d,r] <- NA
    }else{
      asm_mean_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$asm
    }
  }
}
#check it
...
#afr
#create data frame to gather means of afr
afr_mean_s4 <- as.data.frame(matrix(NA,17,11))
colnames(afr_mean_s4) <- c("p",1:10)
afr_mean_s4$p <- prod_prob[2,]
#check it
afr_mean_s4
#extract the mean of afr across the parameter space
for(d in 1:nrow(afr_mean_s4)){
  for(r in 2:ncol(afr_mean_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$afr) == T){
      afr_mean_s4[d,r] <- NA
    }else{
      afr_mean_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$afr
    }
  }
}
#check it
...
#alr
#create data frame to gather means of alr
alr_mean_s4 <- as.data.frame(matrix(NA,17,11))
colnames(alr_mean_s4) <- c("p",1:10)
alr_mean_s4$p <- prod_prob[2,]
#check it
alr_mean_s4
#extract the mean of alr across the parameter space
for(d in 1:nrow(alr_mean_s4)){
  for(r in 2:ncol(alr_mean_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$alr) == T){
      alr_mean_s4[d,r] <- NA
    }else{
      alr_mean_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$alr
    }
  }
}
#check it
...
#meno
#create data frame to gather means of meno
meno_mean_s4 <- as.data.frame(matrix(NA,17,11))
colnames(meno_mean_s4) <- c("p",1:10)
meno_mean_s4$p <- prod_prob[2,]
#check it
meno_mean_s4
#extract the mean of meno across the parameter space
for(d in 1:nrow(meno_mean_s4)){
  for(r in 2:ncol(meno_mean_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$meno) == T){
      meno_mean_s4[d,r] <- NA
    }else{
      meno_mean_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$mean$meno
    }
  }
}
#check it
...
#lng
#create data frame to gather sds of lng
lng_sd_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lng_sd_s4) <- c("p",1:10)
lng_sd_s4$p <- prod_prob[2,]
#check it
lng_sd_s4
#extract the sd of lng across the parameter space
for(d in 1:nrow(lng_sd_s4)){
  for(r in 2:ncol(lng_sd_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$lng) == T){
      lng_sd_s4[d,r] <- NA
    }else{
      lng_sd_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$lng
    }
  }
}
#check it
...
#lro
#create data frame to gather sds of lro
lro_sd_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lro_sd_s4) <- c("p",1:10)
lro_sd_s4$p <- prod_prob[2,]
#check it
lro_sd_s4
#extract the sd of lro across the parameter space
for(d in 1:nrow(lro_sd_s4)){
  for(r in 2:ncol(lro_sd_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$lro) == T){
      lro_sd_s4[d,r] <- NA
    }else{
      lro_sd_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$lro
    }
  }
}
#check it
...
#asm
#create data frame to gather sds of asm
asm_sd_s4 <- as.data.frame(matrix(NA,17,11))
colnames(asm_sd_s4) <- c("p",1:10)
asm_sd_s4$p <- prod_prob[2,]
#check it
asm_sd_s4
#extract the sd of asm across the parameter space
for(d in 1:nrow(asm_sd_s4)){
  for(r in 2:ncol(asm_sd_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$asm) == T){
      asm_sd_s4[d,r] <- NA
    }else{
      asm_sd_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$asm
    }
  }
}
#check it
...
#afr
#create data frame to gather sds of afr
afr_sd_s4 <- as.data.frame(matrix(NA,17,11))
colnames(afr_sd_s4) <- c("p",1:10)
afr_sd_s4$p <- prod_prob[2,]
#check it
afr_sd_s4
#extract the sd of afr across the parameter space
for(d in 1:nrow(afr_sd_s4)){
  for(r in 2:ncol(afr_sd_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$afr) == T){
      afr_sd_s4[d,r] <- NA
    }else{
      afr_sd_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$afr
    }
  }
}
#check it
...
#alr
#create data frame to gather sds of alr
alr_sd_s4 <- as.data.frame(matrix(NA,17,11))
colnames(alr_sd_s4) <- c("p",1:10)
alr_sd_s4$p <- prod_prob[2,]
#check it
alr_sd_s4
#extract the sd of alr across the parameter space
for(d in 1:nrow(alr_sd_s4)){
  for(r in 2:ncol(alr_sd_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$alr) == T){
      alr_sd_s4[d,r] <- NA
    }else{
      alr_sd_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$alr
    }
  }
}
#check it
...
#meno
#create data frame to gather sds of meno
meno_sd_s4 <- as.data.frame(matrix(NA,17,11))
colnames(meno_sd_s4) <- c("p",1:10)
meno_sd_s4$p <- prod_prob[2,]
#check it
meno_sd_s4
#extract the sd of meno across the parameter space
for(d in 1:nrow(meno_sd_s4)){
  for(r in 2:ncol(meno_sd_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$meno) == T){
      meno_sd_s4[d,r] <- NA
    }else{
      meno_sd_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$sd$meno
    }
  }
}
#check it
...
#lng
#create data frame to gather mins of lng
lng_min_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lng_min_s4) <- c("p",1:10)
lng_min_s4$p <- prod_prob[2,]
#check it
lng_min_s4
#extract the min of lng across the parameter space
for(d in 1:nrow(lng_min_s4)){
  for(r in 2:ncol(lng_min_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$lng) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$lng) == T){
      lng_min_s4[d,r] <- NA
    }else{
      lng_min_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$lng
    }
  }
}
#check it
...
#lro
#create data frame to gather mins of lro
lro_min_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lro_min_s4) <- c("p",1:10)
lro_min_s4$p <- prod_prob[2,]
#check it
lro_min_s4
#extract the min of lro across the parameter space
for(d in 1:nrow(lro_min_s4)){
  for(r in 2:ncol(lro_min_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$lro) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$lro) == T){
      lro_min_s4[d,r] <- NA
    }else{
      lro_min_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$lro
    }
  }
}
#check it
...
#asm
#create data frame to gather mins of asm
asm_min_s4 <- as.data.frame(matrix(NA,17,11))
colnames(asm_min_s4) <- c("p",1:10)
asm_min_s4$p <- prod_prob[2,]
#check it
asm_min_s4
#extract the min of asm across the parameter space
for(d in 1:nrow(asm_min_s4)){
  for(r in 2:ncol(asm_min_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$asm) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$asm) == T){
      asm_min_s4[d,r] <- NA
    }else{
      asm_min_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$asm
    }
  }
}
#check it
...
#afr
#create data frame to gather mins of afr
afr_min_s4 <- as.data.frame(matrix(NA,17,11))
colnames(afr_min_s4) <- c("p",1:10)
afr_min_s4$p <- prod_prob[2,]
#check it
afr_min_s4
#extract the min of afr across the parameter space
for(d in 1:nrow(afr_min_s4)){
  for(r in 2:ncol(afr_min_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$afr) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$afr) == T){
      afr_min_s4[d,r] <- NA
    }else{
      afr_min_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$afr
    }
  }
}
#check it
...
#alr
#create data frame to gather mins of alr
alr_min_s4 <- as.data.frame(matrix(NA,17,11))
colnames(alr_min_s4) <- c("p",1:10)
alr_min_s4$p <- prod_prob[2,]
#check it
alr_min_s4
#extract the min of alr across the parameter space
for(d in 1:nrow(alr_min_s4)){
  for(r in 2:ncol(alr_min_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$alr) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$alr) == T){
      alr_min_s4[d,r] <- NA
    }else{
      alr_min_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$alr
    }
  }
}
#check it
...
#meno
#create data frame to gather mins of meno
meno_min_s4 <- as.data.frame(matrix(NA,17,11))
colnames(meno_min_s4) <- c("p",1:10)
meno_min_s4$p <- prod_prob[2,]
#check it
meno_min_s4
#extract the min of meno across the parameter space
for(d in 1:nrow(meno_min_s4)){
  for(r in 2:ncol(meno_min_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$meno) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$meno) == T){
      meno_min_s4[d,r] <- NA
    }else{
      meno_min_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$min$meno
    }
  }
}
#check it
...
#lng
#create data frame to gather maxs of lng
lng_max_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lng_max_s4) <- c("p",1:10)
lng_max_s4$p <- prod_prob[2,]
#check it
lng_max_s4
#extract the max of lng across the parameter space
for(d in 1:nrow(lng_max_s4)){
  for(r in 2:ncol(lng_max_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$lng) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$lng) == T){
      lng_max_s4[d,r] <- NA
    }else{
      lng_max_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$lng
    }
  }
}
#check it
...
#lro
#create data frame to gather maxs of lro
lro_max_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lro_max_s4) <- c("p",1:10)
lro_max_s4$p <- prod_prob[2,]
#check it
lro_max_s4
#extract the max of lro across the parameter space
for(d in 1:nrow(lro_max_s4)){
  for(r in 2:ncol(lro_max_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$lro) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$lro) == T){
      lro_max_s4[d,r] <- NA
    }else{
      lro_max_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$lro
    }
  }
}
#check it
...
#asm
#create data frame to gather maxs of asm
asm_max_s4 <- as.data.frame(matrix(NA,17,11))
colnames(asm_max_s4) <- c("p",1:10)
asm_max_s4$p <- prod_prob[2,]
#check it
asm_max_s4
#extract the max of asm across the parameter space
for(d in 1:nrow(asm_max_s4)){
  for(r in 2:ncol(asm_max_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$asm) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$asm) == T){
      asm_max_s4[d,r] <- NA
    }else{
      asm_max_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$asm
    }
  }
}
#check it
...
#afr
#create data frame to gather maxs of afr
afr_max_s4 <- as.data.frame(matrix(NA,17,11))
colnames(afr_max_s4) <- c("p",1:10)
afr_max_s4$p <- prod_prob[2,]
#check it
afr_max_s4
#extract the max of afr across the parameter space
for(d in 1:nrow(afr_max_s4)){
  for(r in 2:ncol(afr_max_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$afr) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$afr) == T){
      afr_max_s4[d,r] <- NA
    }else{
      afr_max_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$afr
    }
  }
}
#check it
...
#alr
#create data frame to gather maxs of alr
alr_max_s4 <- as.data.frame(matrix(NA,17,11))
colnames(alr_max_s4) <- c("p",1:10)
alr_max_s4$p <- prod_prob[2,]
#check it
alr_max_s4
#extract the max of alr across the parameter space
for(d in 1:nrow(alr_max_s4)){
  for(r in 2:ncol(alr_max_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$alr) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$alr) == T){
      alr_max_s4[d,r] <- NA
    }else{
      alr_max_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$alr
    }
  }
}
#check it
...
#meno
#create data frame to gather maxs of meno
meno_max_s4 <- as.data.frame(matrix(NA,17,11))
colnames(meno_max_s4) <- c("p",1:10)
meno_max_s4$p <- prod_prob[2,]
#check it
meno_max_s4
#extract the max of meno across the parameter space
for(d in 1:nrow(meno_max_s4)){
  for(r in 2:ncol(meno_max_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$meno) == T ||
       is.infinite(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$meno) == T){
      meno_max_s4[d,r] <- NA
    }else{
      meno_max_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$max$meno
    }
  }
}
#check it
...
#lng
#create data frame to gather CVs of lng
lng_cv_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lng_cv_s4) <- c("p",1:10)
lng_cv_s4$p <- prod_prob[2,]
#check it
lng_cv_s4
#extract the CV of lng across the parameter space
for(d in 1:nrow(lng_cv_s4)){
  for(r in 2:ncol(lng_cv_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$lng) == T){
      lng_cv_s4[d,r] <- NA
    }else{
      lng_cv_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$lng
    }
  }
}
#check it
...
#lro
#create data frame to gather CVs of lro
lro_cv_s4 <- as.data.frame(matrix(NA,17,11))
colnames(lro_cv_s4) <- c("p",1:10)
lro_cv_s4$p <- prod_prob[2,]
#check it
lro_cv_s4
#extract the CV of lro across the parameter space
for(d in 1:nrow(lro_cv_s4)){
  for(r in 2:ncol(lro_cv_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$lro) == T){
      lro_cv_s4[d,r] <- NA
    }else{
      lro_cv_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$lro
    }
  }
}
#check it
...
#asm
#create data frame to gather CVs of asm
asm_cv_s4 <- as.data.frame(matrix(NA,17,11))
colnames(asm_cv_s4) <- c("p",1:10)
asm_cv_s4$p <- prod_prob[2,]
#check it
asm_cv_s4
#extract the CV of asm across the parameter space
for(d in 1:nrow(asm_cv_s4)){
  for(r in 2:ncol(asm_cv_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$asm) == T){
      asm_cv_s4[d,r] <- NA
    }else{
      asm_cv_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$asm
    }
  }
}
#check it
...
#afr
#create data frame to gather CVs of afr
afr_cv_s4 <- as.data.frame(matrix(NA,17,11))
colnames(afr_cv_s4) <- c("p",1:10)
afr_cv_s4$p <- prod_prob[2,]
#check it
afr_cv_s4
#extract the CV of afr across the parameter space
for(d in 1:nrow(afr_cv_s4)){
  for(r in 2:ncol(afr_cv_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$afr) == T){
      afr_cv_s4[d,r] <- NA
    }else{
      afr_cv_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$afr
    }
  }
}
#check it
...
#alr
#create data frame to gather CVs of alr
alr_cv_s4 <- as.data.frame(matrix(NA,17,11))
colnames(alr_cv_s4) <- c("p",1:10)
alr_cv_s4$p <- prod_prob[2,]
#check it
alr_cv_s4
#extract the CV of alr across the parameter space
for(d in 1:nrow(alr_cv_s4)){
  for(r in 2:ncol(alr_cv_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$alr) == T){
      alr_cv_s4[d,r] <- NA
    }else{
      alr_cv_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$alr
    }
  }
}
#check it
...
#meno
#create data frame to gather CVs of meno
meno_cv_s4 <- as.data.frame(matrix(NA,17,11))
colnames(meno_cv_s4) <- c("p",1:10)
meno_cv_s4$p <- prod_prob[2,]
#check it
meno_cv_s4
#extract the CV of meno across the parameter space
for(d in 1:nrow(meno_cv_s4)){
  for(r in 2:ncol(meno_cv_s4)){
    if(is.null(summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$meno) == T){
      meno_cv_s4[d,r] <- NA
    }else{
      meno_cv_s4[d,r] <- summary_stats_s4[grep(paste("d",d,"",sep="_"),names(summary_stats_s4))][[r-1]]$cv$meno
    }
  }
}
#check it
...
#scenario 1
for(d in 1:nrow(lng_cv_s1)){
    points((rep(lng_cv_s1[d,1],10)-0.01),
           as.numeric(lng_cv_s1[d,2:11]),
           pch=16,
           col=alpha("orange",0.1)
           )    
}
points((lht_mean_s1$p-0.01),
       lht_mean_s1$lng,
       pch=16,cex=1,col="orange")
#scenario 4
for(d in 1:nrow(lng_cv_s4)){
  points((rep(lng_cv_s4[d,1],10)+0.01),
         as.numeric(lng_cv_s4[d,2:11]),
         pch=17,
         col=alpha("skyblue",0.1)
  )    
}
points((lht_mean_s4$p+0.01),
       lht_mean_s4$lng,
...
#scenario 1
for(d in 1:nrow(lro_cv_s1)){
  points((rep(lro_cv_s1[d,1],10)-0.01),
...
#scenario 4
for(d in 1:nrow(lro_cv_s4)){
  points((rep(lro_cv_s4[d,1],10)+0.01),
         as.numeric(lro_cv_s4[d,2:11]),
         pch=17,
         col=alpha("skyblue",0.1)
  )    
}
...
#scenario 1
for(d in 1:nrow(asm_cv_s1)){
  points((rep(asm_cv_s1[d,1],10)-0.01),
...
#scenario 4
for(d in 1:nrow(asm_cv_s4)){
  points((rep(asm_cv_s4[d,1],10)+0.01),
         as.numeric(asm_cv_s4[d,2:11]),
         pch=17,
         col=alpha("skyblue",0.1)
  )    
}
...
#scenario 1
for(d in 1:nrow(afr_cv_s1)){
  points((rep(afr_cv_s1[d,1],10)-0.01),
...
#scenario 4
for(d in 1:nrow(afr_cv_s4)){
  points((rep(afr_cv_s4[d,1],10)+0.01),
         as.numeric(afr_cv_s4[d,2:11]),
         pch=17,
         col=alpha("skyblue",0.1)
  )    
}
...
#scenario 1
for(d in 1:nrow(alr_cv_s1)){
  points((rep(alr_cv_s1[d,1],10)-0.01),
...
#scenario 4
for(d in 1:nrow(alr_cv_s4)){
  points((rep(alr_cv_s4[d,1],10)+0.01),
         as.numeric(alr_cv_s4[d,2:11]),
         pch=17,
         col=alpha("skyblue",0.1)
  )    
}
...
#scenario 1
for(d in 1:nrow(meno_cv_s1)){
  points((rep(meno_cv_s1[d,1],10)-0.01),
...
#scenario 4
for(d in 1:nrow(meno_cv_s4)){
  points((rep(meno_cv_s4[d,1],10)+0.01),
         as.numeric(meno_cv_s4[d,2:11]),
         pch=17,
         col=alpha("skyblue",0.1)
  )    
}
