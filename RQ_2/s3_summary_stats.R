...
output_dir <- "./RQ_2/lht_summaries_s3"
...
summary_dir <- "./RQ_2/lht_summaries_s3"
...
saveRDS(lng_mean_s3,file="./RQ_2/lng_mean_s3.RData")
saveRDS(lro_mean_s3,file="./RQ_2/lro_mean_s3.RData")
saveRDS(asm_mean_s3,file="./RQ_2/asm_mean_s3.RData")
saveRDS(afr_mean_s3,file="./RQ_2/afr_mean_s3.RData")
saveRDS(alr_mean_s3,file="./RQ_2/alr_mean_s3.RData")
saveRDS(meno_mean_s3,file="./RQ_2/meno_mean_s3.RData")
...
saveRDS(lng_sd_s3,file="./RQ_2/lng_sd_s3.RData")
saveRDS(lro_sd_s3,file="./RQ_2/lro_sd_s3.RData")
saveRDS(asm_sd_s3,file="./RQ_2/asm_sd_s3.RData")
saveRDS(afr_sd_s3,file="./RQ_2/afr_sd_s3.RData")
saveRDS(alr_sd_s3,file="./RQ_2/alr_sd_s3.RData")
saveRDS(meno_sd_s3,file="./RQ_2/meno_sd_s3.RData")
...
saveRDS(lng_min_s3,file="./RQ_2/lng_min_s3.RData")
saveRDS(lro_min_s3,file="./RQ_2/lro_min_s3.RData")
saveRDS(asm_min_s3,file="./RQ_2/asm_min_s3.RData")
saveRDS(afr_min_s3,file="./RQ_2/afr_min_s3.RData")
saveRDS(alr_min_s3,file="./RQ_2/alr_min_s3.RData")
saveRDS(meno_min_s3,file="./RQ_2/meno_min_s3.RData")
...
saveRDS(lng_max_s3,file="./RQ_2/lng_max_s3.RData")
saveRDS(lro_max_s3,file="./RQ_2/lro_max_s3.RData")
saveRDS(asm_max_s3,file="./RQ_2/asm_max_s3.RData")
saveRDS(afr_max_s3,file="./RQ_2/afr_max_s3.RData")
saveRDS(alr_max_s3,file="./RQ_2/alr_max_s3.RData")
saveRDS(meno_max_s3,file="./RQ_2/meno_max_s3.RData")
...
saveRDS(lng_cv_s3,file="./RQ_2/lng_cv_s3.RData")
saveRDS(lro_cv_s3,file="./RQ_2/lro_cv_s3.RData")
saveRDS(asm_cv_s3,file="./RQ_2/asm_cv_s3.RData")
saveRDS(afr_cv_s3,file="./RQ_2/afr_cv_s3.RData")
saveRDS(alr_cv_s3,file="./RQ_2/alr_cv_s3.RData")
saveRDS(meno_cv_s3,file="./RQ_2/meno_cv_s3.RData")
