...
output_dir <- "./RQ_3/lht_summaries_s2"
...
saveRDS(lht_mean_s2,file="./RQ_3/lht_mean_s2.RData")
...
saveRDS(lht_sd_s2,file="./RQ_3/lht_sd_s2.RData")
...
saveRDS(lht_min_s2,file="./RQ_3/lht_min_s2.RData")
...
saveRDS(lht_max_s2,file="./RQ_3/lht_max_s2.RData")
...
saveRDS(lht_cv_s2,file="./RQ_3/lht_cv_s2.RData")
