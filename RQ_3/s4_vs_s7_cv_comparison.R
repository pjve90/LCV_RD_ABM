...
lng_cv_s4 <- readRDS("./RQ_3/lng_cv_s4.RData")
lro_cv_s4 <- readRDS("./RQ_3/lro_cv_s4.RData")
asm_cv_s4 <- readRDS("./RQ_3/asm_cv_s4.RData")
afr_cv_s4 <- readRDS("./RQ_3/afr_cv_s4.RData")
alr_cv_s4 <- readRDS("./RQ_3/alr_cv_s4.RData")
meno_cv_s4 <- readRDS("./RQ_3/meno_cv_s4.RData")
...
process_cv_s4 <- function(summary_dir) {
...
# Helper function to process CVs for a given scenario directory
process_cv_s7 <- function(summary_dir) {
  # Initialize a vector to store CV values
  cv_values <- c()
...
cv_all <- c(process_cv_s4(summary_dir_s4), process_cv_s7(summary_dir_s7))
...
#   if(sum(is.na(lng_cv_s7[d,2:11])) < 10){
#     segments(x0 = lng_cv_s7[d,1],
#              y0 = min(lng_cv_s7[d,2:11],na.rm=T),
#              x1 = lng_cv_s7[d,1],
#              y1 = max(lng_cv_s7[d,2:11],na.rm=T), 
...
#   if(sum(is.na(lro_cv_s7[d,2:11])) < 10){
#     segments(x0 = lro_cv_s7[d,1],
#              y0 = min(lro_cv_s7[d,2:11],na.rm=T),
#              x1 = lro_cv_s7[d,1],
#              y1 = max(lro_cv_s7[d,2:11],na.rm=T), 
#              col = alpha(palette[2],0.5),
#              lwd=1
#     )
#   }
...
#   if(sum(is.na(asm_cv_s7[d,2:11])) < 10){
#     segments(x0 = asm_cv_s7[d,1],
#              y0 = min(asm_cv_s7[d,2:11],na.rm=T),
#              x1 = asm_cv_s7[d,1],
#              y1 = max(asm_cv_s7[d,2:11],na.rm=T), 
#              col = alpha(palette[2],0.5),
#              lwd=1
#     )
#   }
...
#   if(sum(is.na(afr_cv_s7[d,2:11])) < 10){
#     segments(x0 = afr_cv_s7[d,1],
#              y0 = min(afr_cv_s7[d,2:11],na.rm=T),
#              x1 = afr_cv_s7[d,1],
#              y1 = max(afr_cv_s7[d,2:11],na.rm=T), 
#              col = alpha(palette[2],0.5),
#              lwd=1
#     )
#   }
...
#   if(sum(is.na(alr_cv_s7[d,2:11])) < 10){
#     segments(x0 = alr_cv_s7[d,1],
#              y0 = min(alr_cv_s7[d,2:11],na.rm=T),
#              x1 = alr_cv_s7[d,1],
#              y1 = max(alr_cv_s7[d,2:11],na.rm=T), 
#              col = alpha(palette[2],0.5),
#              lwd=1
#     )
#   }
...
#   if(sum(is.na(meno_cv_s7[d,2:11])) < 10){
#     segments(x0 = meno_cv_s7[d,1],
#              y0 = min(meno_cv_s7[d,2:11],na.rm=T),
#              x1 = meno_cv_s7[d,1],
#              y1 = max(meno_cv_s7[d,2:11],na.rm=T), 
#              col = alpha(palette[2],0.5),
#              lwd=1
#     )
#   }
...
# Scenario 4 Legend (Slot 7, first row)
par(mar = c(0, 0, 0, 0))  # Adjust margins for the legend area
plot.new()  # Create an empty plot for the legend
legend("center", 
       title = "Scenario 4:\nProduction probability", 
       legend = prod_prob[2, valid_indices], 
       col = palette[1], 
       pch = 1, 
       bty = "n", 
       cex = 1.2)

# Scenario 7 Legend (Slot 7, second row)
