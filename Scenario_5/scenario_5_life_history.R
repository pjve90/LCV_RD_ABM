# Life cycle variation and resource dynamics ABM: Scenario 5 - life history calculation ----

#Here is the code to calculate the life history tratis from the simulation of Scenario 5, which aims to understand the influence of resource production on the variability of life cycles.
...
raw_sim <- readRDS("./Scenario_5/raw_simulation_s5.RData")
...
saveRDS(lht_list,file="./Scenario_5/lht_list_s5.RData")
