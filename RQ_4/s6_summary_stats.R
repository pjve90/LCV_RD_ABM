...
output_dir <- "./RQ_4/lht_summaries_s6"
...
summary_dir <- "./RQ_4/lht_summaries_s6"
...
saveRDS(lng_mean_s6,file="./RQ_4/lng_mean_s6.RData")
saveRDS(lro_mean_s6,file="./RQ_4/lro_mean_s6.RData")
saveRDS(asm_mean_s6,file="./RQ_4/asm_mean_s6.RData")
saveRDS(afr_mean_s6,file="./RQ_4/afr_mean_s6.RData")
saveRDS(alr_mean_s6,file="./RQ_4/alr_mean_s6.RData")
saveRDS(meno_mean_s6,file="./RQ_4/meno_mean_s6.RData")
...
saveRDS(lng_sd_s6,file="./RQ_4/lng_sd_s6.RData")
saveRDS(lro_sd_s6,file="./RQ_4/lro_sd_s6.RData")
saveRDS(asm_sd_s6,file="./RQ_4/asm_sd_s6.RData")
saveRDS(afr_sd_s6,file="./RQ_4/afr_sd_s6.RData")
saveRDS(alr_sd_s6,file="./RQ_4/alr_sd_s6.RData")
saveRDS(meno_sd_s6,file="./RQ_4/meno_sd_s6.RData")
...
saveRDS(lng_min_s6,file="./RQ_4/lng_min_s6.RData")
saveRDS(lro_min_s6,file="./RQ_4/lro_min_s6.RData")
saveRDS(asm_min_s6,file="./RQ_4/asm_min_s6.RData")
saveRDS(afr_min_s6,file="./RQ_4/afr_min_s6.RData")
saveRDS(alr_min_s6,file="./RQ_4/alr_min_s6.RData")
saveRDS(meno_min_s6,file="./RQ_4/meno_min_s6.RData")
...
saveRDS(lng_max_s6,file="./RQ_4/lng_max_s6.RData")
saveRDS(lro_max_s6,file="./RQ_4/lro_max_s6.RData")
saveRDS(asm_max_s6,file="./RQ_4/asm_max_s6.RData")
saveRDS(afr_max_s6,file="./RQ_4/afr_max_s6.RData")
saveRDS(alr_max_s6,file="./RQ_4/alr_max_s6.RData")
saveRDS(meno_max_s6,file="./RQ_4/meno_max_s6.RData")
...
saveRDS(lng_cv_s6,file="./RQ_4/lng_cv_s6.RData")
saveRDS(lro_cv_s6,file="./RQ_4/lro_cv_s6.RData")
saveRDS(asm_cv_s6,file="./RQ_4/asm_cv_s6.RData")
saveRDS(afr_cv_s6,file="./RQ_4/afr_cv_s6.RData")
saveRDS(alr_cv_s6,file="./RQ_4/alr_cv_s6.RData")
saveRDS(meno_cv_s6,file="./RQ_4/meno_cv_s6.RData")
